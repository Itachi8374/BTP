...
//This holds all the information about a gaama

typedef struct gamma_node
{
	int n[20][20];
	int c[20];
...
void trackPath (FSMD*, int, PATHS_LIST*, STACK* );
void findpaths( FSMD*, PATHS_LIST*, var_list*);
...
void Associate_R_and_r_alpha(FSMD*, PATHS_LIST* , var_list*, int);
void printVariable(var_list*); 
